      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="bg-white rounded-3xl p-8 shadow-lg">
            ...
            <h3 className="text-2xl font-bold text-nookly-blue mb-4">Spice It Up - Intimacy Game (Q1 2025)</h3>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-lg">
            ...
            <h3 className="text-2xl font-bold text-nookly-blue mb-4">Virtual Shared Experiences (Q2 2025)</h3>
            <p className="text-gray-600 leading-relaxed mb-6">
              Music listening parties, virtual movie watching, shared games and activities, real-time reactions and chat to connect before meeting in person.
            </p>
