...
var MemStorage = class {
  ...
  constructor() {
    ...
    this.newsletterSignups = /* @__PURE__ */ new Map();
  }
  async getUser(id) {
  ...
  async createNewsletterSignup(insertSignup) {
    const id = randomUUID();
    const signup = {
      ...insertSignup,
      id,
  ...
  async getNewsletterSignupByEmail(email) {
...
var insertNewsletterSignupSchema = createInsertSchema(newsletterSignups).omit({
  id: true,
  createdAt: true
});
